				...
				<div class="row">
					<div class="ft-left col-sm-4 col-md-4 col-lg-4">
						<ul class="ft-sns">
							...
							<li><a href="http://pf.kakao.com/_xkFAmxl" target="_blank">
								<i class="fa fa-comment fa-2x" aria-hidden="true"></i></a>
							</li>
							<li>
								<a href="https://www.facebook.com/wiselyshave" target="_blank">
									<i class="fa fa-facebook-official fa-2x" aria-hidden="true"></i>
								</a>
							</li>
							<li>
								<a href="https://www.instagram.com/wiselyshave" target="_blank">
					...
					<div
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class=" seese-widget footer-1-widget widget_nav_menu">
								<ul id="menu-footer-menu" class="main-navigation">
									<li id="menu-item-3969"
										...
										href="https://www.wiselyshave.com/store/#privacy">개인정보처리방침</a></li>
									<li id="menu-item-3971"
										...
										href="https://www.wiselyshave.com/store/#terms">이용약관</a></li>
									<li id="menu-item-3972"
										...
										href="https://www.wiselyshave.com/store/#guide">이용안내</a></li>
									<li id="menu-item-2724517"
										...
										href="https://www.wiselyshave.com/store/#career">채용</a></li>
								</ul>
								<div class="clear"></div>
							</div>
							<!-- end widget -->
							<div class=" seese-widget footer-1-widget widget_text">
								<div class="textwidget">
									<p>
										<b>주식회사 와이즐리컴퍼니</b>&nbsp;서울특별시 성동구 왕십리로 125, 8층 801호(성수동1가,
										KD타워)<br> <b>대표자:</b> 김동욱 <b>사업자등록번호:</b> 344-88-00965 <a
											class="underline wisely-ext-lightbox"
											href="https://www.wiselyshave.com/store/#company-info"
											rel="noopener">사업자정보확인</a><br> <b>통신판매업신고번호:</b>
										2019-서울성동-01739&nbsp;<b>개인정보보호책임자:</b> 김윤호 <a
											class="link-email" href="mailto:yhkim@wiselyshave.com"
											target="_blank" rel="noopener">yhkim@wiselyshave.com</a><br>
										<b>전화번호:</b> <a class="link-email" href="tel:1833-9133">1833-9133</a>
										<b>E-mail:</b> <a class="link-email"
											href="mailto:help@wiselyshave.com" target="_blank"
											rel="noopener">help@wiselyshave.com</a>
									</p>
									<div>
										고객님은 안전거래를 위해 현금 등으로 결제 시 저희 쇼핑몰에서 가입한 나이스페이먼츠(주)의 구매안전서비스를
										이용하실 수 있습니다. <a class="underline wisely-ext-lightbox"
											href="https://www.wiselyshave.com/store/#nicepay"
											rel="noopener">서비스 가입사실 확인</a>
									</div>
									<div>
						...
						<div class="seese-copyright col-xs-12">
							<div class="">Copyright ©2020 WISELY. All rights reserved.
							</div>
						</div>
					</div>
				</div>
